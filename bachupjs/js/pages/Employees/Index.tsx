...
export default function Index({ auth, employees, filters = {}, departments = [], positions = [] }: Props) {
  ...
  const getAssignmentBadge = (assignment: Employee['current_assignment']) => {
    ...
    const variant = variants[assignment.type as keyof typeof variants] || 'default';
    return (
      <Badge variant={variant as any}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <Card>
          ...
          <CardContent>
            ...
            {employees?.meta?.total > 0 && employees?.links && (
              <div className="mt-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Button
                    ...
                    onClick={() => employees.links.prev && router.get(employees.links.prev)}
                  >
                    Previous
                  </Button>
                  <Button
                    ...
                    onClick={() => employees.links.next && router.get(employees.links.next)}
                  >
                    Next
                  </Button>
                </div>
