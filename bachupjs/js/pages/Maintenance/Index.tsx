...
import { MaintenanceRecord, Equipment } from '@/types/models';
                  ...
                  {maintenanceRecords.data.length > 0 ? (
                    maintenanceRecords.data.map((record) => (
                      <TableRow key={record.id}>
                        ...
                        <TableCell>
                          {record.maintenance_type ? record.maintenance_type.charAt(0).toUpperCase() + record.maintenance_type.slice(1).replace('_', ' ') : '-'}
                        </TableCell>
