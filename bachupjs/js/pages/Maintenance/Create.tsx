...
import { Equipment, MaintenancePart } from '@/types/models';
...
export default function Create({ auth, equipment, employees, inventoryItems, parts = [], selectedEquipment }: Props) {
  ...
  // Add useEffect to update equipment_id when selectedEquipment changes
  useEffect(() => {
    if (selectedEquipment) {
      setData('equipment_id', selectedEquipment.toString());
    }
  }, [selectedEquipment]);
  ...
  return (
    <AdminLayout title="Create Maintenance Record" breadcrumbs={[
      ...
      <div className="flex h-full flex-1 flex-col gap-4 p-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-2xl font-bold">Create Maintenance Record</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                      ...
                      <Calendar
                        ...
                        onSelect={(date) => {
                          if (date) {
                            ...
                            setData('maintenance_date', format(date, 'yyyy-MM-dd'));
                          }
                        }}
                        initialFocus
                      />
                  ...
                  {errors.maintenance_date && <p className="text-red-500 text-sm">{errors.maintenance_date}</p>}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setData('performed_by', value)}
                ...
                <div className="space-y-2">
                  ...
                  {errors.next_maintenance_date && <p className="text-red-500 text-sm">{errors.next_maintenance_date}</p>}
                </div>
              </div>
              ...
              <div className="flex justify-end space-x-2">
                <Button variant="outline" asChild>
                  <Link href={route('maintenance.index')}>Cancel</Link>
                </Button>
