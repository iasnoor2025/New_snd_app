              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={errors.file_number ? 'border-red-500' : ''}
                  />
                  {errors.file_number && (
                    <p className="text-red-500 text-sm">{errors.file_number.message}</p>
                  )}
                </div>
            ...
            <TabsContent value="documents" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <DatePicker
                    date={watch('iqama_expiry')}
                    onSelect={(date) => handleDateChange('iqama_expiry', date)}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <DatePicker
                    date={watch('passport_expiry')}
                    onSelect={(date) => handleDateChange('passport_expiry', date)}
                  />
                </div>
              </div>
