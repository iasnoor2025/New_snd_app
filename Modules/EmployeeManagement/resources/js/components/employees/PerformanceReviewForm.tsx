...
const formSchema = z.object({
  ...
  review_period_end: z.date({ required_error: 'Review period end date is required' })
...
const PerformanceReviewForm: React.FC<PerformanceReviewFormProps> = ({
  ...
  const {
    ...
    defaultValues: review ? mapReviewToFormValues(review) : {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {review ? 'Update performance review information' : 'Create a new employee performance review'}
        </CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
