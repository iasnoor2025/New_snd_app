            ...
            <div className="flex justify-between items-center mt-6 text-sm text-gray-500">
              ...
              <div className="rounded-md bg-gray-50 px-3 py-1.5">
                <div className="flex items-center gap-3">
                  <div>
                    <span className="font-medium">Total Regular:</span> {entries.reduce((acc, entry) => acc + entry.hours_worked, 0).toFixed(2)} hrs
                  </div>
                  <div>
                    <span className="font-medium">Total Overtime:</span> {entries.reduce((acc, entry) => acc + entry.overtime_hours, 0).toFixed(2)} hrs
                  </div>
                </div>
              </div>
            </div>
