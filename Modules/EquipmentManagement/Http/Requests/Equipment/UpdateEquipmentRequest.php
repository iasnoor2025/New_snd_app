...
class UpdateEquipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'serial_number' => 'required|string|max:255|unique:equipment,serial_number,' . $this->equipment->id,
            'door_number' => 'required|string|max:255|unique:equipment,door_number,' . $this->equipment->id,
